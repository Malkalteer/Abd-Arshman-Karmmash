      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="col-span-1 lg:col-span-1">
            ...
            <p> حاصل على شهادة icdl في قيادة الحاسب الٱلي</p>
            <p> حاصل على شهادة من غرفة تجارة دمشق</p>
            <p> حاصل على شهادة في برمجيات المحاسبية</p>
            <p> خبرة سنتين في شركة البينة التابعة لشركة خليفة القابضة</p>
            ...
            <div className="flex space-x-4 space-x-reverse">
                ...
                <a key={"linkedin"} href="https://t.me/+218943928675" target="_blank" className="w-10 h-10 rounded-full bg-slate-100 dark:bg-slate-800 flex items-center justify-center text-slate-500 hover:bg-primary-600 hover:text-white transition-all">
                ...
                <a key={"whatsapp"} href="https://api.whatsapp.com/qr/MXGN67EWNICCA1" target="_blank" className="w-10 h-10 rounded-full bg-slate-100 dark:bg-slate-800 flex items-center justify-center text-slate-500 hover:bg-primary-600 hover:text-white transition-all">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-600 dark:text-slate-400 mt-1">abd568742@gmail.com</p>
                </div>
              </div>
