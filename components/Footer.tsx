        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="col-span-1 lg:col-span-1">
            ...
            <div className="flex space-x-4 space-x-reverse">
                ...
                <a key={"whatsapp"} href="https://wa.me/+218943928675" target="_blank" className="w-10 h-10 rounded-full bg-slate-100 dark:bg-slate-800 flex items-center justify-center text-slate-500 hover:bg-primary-600 hover:text-white transition-all">
